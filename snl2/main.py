...
class game_board(object):
    def __init__(self, master, img):
        ...
        self.start_game = Button(self.canvas, text="Start", background='white', command=self.start_game,
                                 font=("Helvetica"))
    ...
    def player_pieces(self, dice_number, turn):
        ...
        self.x, self.y, self.block[turn] = matching_position().find_snake_or_ladder(self.block[turn], turn,
                                                                                    [self.x, self.y])
...
def main():
    ...
    img = PhotoImage(file="peakpx.png",height=1500,width=1800)
